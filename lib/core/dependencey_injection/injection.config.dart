...
import '../../domain/blockchain/interface/i_blockchain_service.dart' as _i4;
...
import 'register_injectable_module.dart' as _i13;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.lazySingleton<_i6.IConnectivityService>(
      () => _i7.ConnectivityService(connectivity: gh<_i3.Connectivity>()));
  gh.lazySingleton<_i8.IWalletService>(() => _i9.WalletService());
  gh.factory<_i10.WalletBloc>(() => _i10.WalletBloc(gh<_i8.IWalletService>()));
  gh.factory<_i11.BlockchainBloc>(
      () => _i11.BlockchainBloc(gh<_i4.IBlockchainService>()));
  gh.factory<_i12.ConnectivityCubit>(
      () => _i12.ConnectivityCubit(gh<_i6.IConnectivityService>()));
  return getIt;
}
